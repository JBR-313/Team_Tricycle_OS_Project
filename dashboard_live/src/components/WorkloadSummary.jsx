...
export default function WorkloadSummary({ workloadSummary: wl }) {
  if (!wl) return <Card label="Workload Summary" className="card-wl"><div className="loading">Loading…</div></Card>

  const n      = wl.process_count || 0
